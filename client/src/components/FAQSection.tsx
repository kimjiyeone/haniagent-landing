...
const faqs = [
  ...
  {
    q: "녹음 데이터는 안전한가요?",
    a: "모든 음성 데이터는 TLS 1.3 + AES-256 암호화로 전송·저장되며, SOAP 차트 생성 후 녹음 원본은 즉시 삭제됩니다. 클리닉 간 완벽한 데이터 격리 아키텍처를 적용하고 있으며, 정보보호 배상책임보험에도 가입되어 있습니다.",
  },
  {
  ...
  {
    q: "카톡은 자동으로 발송되나요?",
    a: "현재는 AI가 차트 기반 맞춤 카톡 메시지를 자동 생성하고, 실장님이 인박스에서 복사하여 카카오톡으로 발송하는 방식입니다. 2026년 Q4에 카카오 알림톡 연동을 통한 자동 발송 기능이 업데이트될 예정입니다.",
  },
  {
    q: "도입까지 얼마나 걸리나요?",
