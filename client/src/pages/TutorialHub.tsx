 ...
 * Stage 1: 전체 플로우 보기 (모든 역할 공통)
 * Stage 2: 역할별 실전 가이드 (원장 OR 실장)
 */
      ...
      <div className="pt-[80px] pb-16 px-5">
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="mt-3 text-[15px] text-[#888] max-w-md mx-auto leading-relaxed">
              전체 플로우를 먼저 이해한 후,<br className="sm:hidden" />
              역할별 실전 가이드를 진행하세요.
            </p>
          </motion.div>
          ...
          >
            ...
            <a
              href="/tutorial/flow"
              className="group block bg-[#f8fafb] border border-[#e8e8e8] rounded-2xl p-6 hover:border-[#00B6C5] hover:shadow-[0_4px_24px_rgba(0,182,197,0.08)] transition-all"
            >
              <h3 className="text-[17px] font-bold text-[#111] mb-2">전체 플로우 보기</h3>
              <p className="text-[13px] text-[#666] leading-relaxed mb-4">
                환자 도착부터 진료 완료까지, 원장과 실장이 함께 만드는 하루의 전체 흐름을 체험합니다.
              </p>
              <p className="text-[12px] text-[#999] mb-4">약 3분 소요 · 모든 역할 공통</p>
          ...
          >
            ...
            <p className="text-[13px] text-[#888] mb-5 pl-9">
              전체 플로우를 이해한 후, 본인 역할에 맞는 가이드를 진행하세요.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                <h3 className="text-[18px] font-extrabold text-[#111] mb-1">원장님 실전 가이드</h3>
                <p className="text-[12px] text-[#999] mb-3">6 Steps · 약 3분</p>
                <p className="text-[13px] text-[#666] leading-relaxed mb-4">
              ...
              <motion.a
                ...
                className="group block bg-white border border-[#e8e8e8] rounded-2xl p-6 hover:border-[#00B6C5] hover:shadow-[0_4px_24px_rgba(0,182,197,0.08)] transition-all"
              >
                <h3 className="text-[18px] font-extrabold text-[#111] mb-1">실장님 실전 가이드</h3>
                <p className="text-[12px] text-[#999] mb-3">7 Steps · 약 3분</p>
                <p className="text-[13px] text-[#666] leading-relaxed mb-4">
          ...
          >
            <p className="text-[12px] text-[#bbb]">
              전체 플로우를 먼저 보신 후 역할별 가이드를 진행하시면 가장 효과적입니다.
            </p>
